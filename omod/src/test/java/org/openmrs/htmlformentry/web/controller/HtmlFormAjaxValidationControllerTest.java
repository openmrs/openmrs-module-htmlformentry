...
public class HtmlFormAjaxValidationControllerTest extends BaseModuleWebContextSensitiveTest {
	...
	public void testFormWithoutDuplicateEncounter() throws Exception {
		controller.duplicateForm(new ModelMap(), request, response, new Integer(5), new Integer(5), "2011-04-04",
		    "yyyy-MM-dd");
	...
	public void testFormWithDuplicateEncounter() throws Exception {
		controller.duplicateForm(new ModelMap(), request, response, new Integer(1), new Integer(2), "2008-08-19",
		    "yyyy-MM-dd");
		Assert.assertEquals(response.getContentAsString(), "false");
	}
}
