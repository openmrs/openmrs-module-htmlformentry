...
public class HtmlFormEncounterControllerTest {
	...
	public void shouldBuildSchemaWithSectionsNestedSections() {
		...
		JsonNode schemaAsJson = new HtmlFormEncounterController().buildSchemaAsJsonNode(schema, new ObjectMapper());
		assertThat(schemaAsJson.get("sections").get(0).get("name").getValueAsText(), is("Section 1"));
		assertThat(schemaAsJson.get("sections").get(0).get("sections").get(0).get("name").getValueAsText(),
		    is("Section 1a"));
		assertThat(schemaAsJson.get("sections").get(0).get("sections").get(1).get("name").getValueAsText(),
		    is("Section 1b"));
		assertThat(schemaAsJson.get("sections").get(1).get("name").getValueAsText(), is("Section 2"));
	...
	public void shouldBuildSchemaWithSectionsAndObsFields() {
		...
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(1).get("datatype").getValueAsText(),
		    is("datetime"));
		assertThat(schemaAsJson.get("sections").get(1).get("name").getValueAsText(), is("Section 2"));
	...
	public void shouldBuildSchemaWithSectionsAndObsGroup() {
		...
		assertThat(
		    schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(0).get("name").getValueAsText(),
		    is("Field 1"));
		assertThat(
		    schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(0).get("datatype").getValueAsText(),
		    is("numeric"));
		assertThat(
		    schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(1).get("name").getValueAsText(),
		    is("Field 2"));
		assertThat(
		    schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(1).get("datatype").getValueAsText(),
		    is("datetime"));
	...
	public void shouldBuildSchemaWithSectionsAndNestedObsGroup() {
		...
		assertThat(
		    schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(0).get("name").getValueAsText(),
		    is("Nested ObsGroup"));
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(0).get("fields").get(0)
		        .get("name").getValueAsText(),
		    is("Field 1"));
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(0).get("fields").get(0).get("fields").get(0)
		        .get("datatype").getValueAsText(),
		    is("numeric"));
	...
	public void shouldBuildSchemaWithSectionsAndObsFieldsWithValues() {
		...
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(1).get("datatype").getValueAsText(),
		    is("datetime"));
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(1).get("value").getValueAsText(),
		    is(datetimeFormat.format(obsDateValue)));
		...
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(2).get("value").getValueAsText(),
		    is(timeFormat.format(obsDateValue)));
		...
		assertThat(schemaAsJson.get("sections").get(0).get("fields").get(3).get("value").getValueAsText(),
		    is(dateFormat.format(obsDateValue)));
