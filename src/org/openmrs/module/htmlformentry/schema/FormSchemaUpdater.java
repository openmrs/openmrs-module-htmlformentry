...
public class FormSchemaUpdater {
	...
	private void addExtraFields() {
		findOrCreateFieldByName("PATIENT.PATIENT_ID", conceptType, patientSection, 0);
		findOrCreateFieldByName("ENCOUNTER.ENCOUNTER_DATETIME", conceptType, encounterSection, 0);
		findOrCreateFieldByName("ENCOUNTER.LOCATION_ID", conceptType, encounterSection, 0);
		findOrCreateFieldByName("ENCOUNTER.PROVIDER_ID", conceptType, encounterSection, 0);
	}
...
private Field findOrCreateField(Concept concept, FieldType type) {
	...
	private FormField findOrCreateFieldByName(String name, FieldType type, FormField parent, int index) {
		FormField field = null;
