...
public class SectionTagHandlerTest {
	...
	public void testDefaultBehavior() throws Exception {
		...
		TestUtil.assertFuzzyEquals(out.getContent(),
		    "<div class=\"section\"> <span class=\"sectionHeader\">" + LABEL_TEXT + "</span> ");
	...
	public void testSpecifyingSectionAndHeaderTags() throws Exception {
		Node sectionNode = getSectionNode("<section sectionTag=\"section\" headerTag=\"h1\" headerLabel=\"" + LABEL_TEXT
		        + "\"> " + SECTION_CONTENT + " </section>");
		
		assertTrue(handler.doStartTag(formEntrySession, out, sectionNode.getParentNode(), sectionNode));
		TestUtil.assertFuzzyEquals(out.getContent(),
		    "<section class=\"section\"> <h1 class=\"sectionHeader\">" + LABEL_TEXT + "</h1>");
