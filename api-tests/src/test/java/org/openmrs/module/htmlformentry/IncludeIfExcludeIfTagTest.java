...
public class IncludeIfExcludeIfTagTest extends BaseHtmlFormEntryTest {
	...
	public void doubleNestedIncludeIf_shouldBeProcessedCorrectly() throws Exception {
		String htmlform = "<htmlform>" + "<includeIf velocityTest=\"false\">" + "<includeIf velocityTest=\"true\">"
		        + "included" + "</includeIf>" + "</includeIf>" + "</htmlform>";
	...
	public void tripleNestedIncludeIf_shouldBeProcessedCorrectly() throws Exception {
		String htmlform = "<htmlform>" + "<includeIf velocityTest=\"false\">" + "<includeIf velocityTest=\"true\">"
		        + "<includeIf velocityTest=\"true\">" + "included" + "</includeIf>" + "</includeIf>" + "</includeIf>"
		        + "</htmlform>";
