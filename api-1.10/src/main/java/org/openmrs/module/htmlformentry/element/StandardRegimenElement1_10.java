 ...
 *
 */
public class StandardRegimenElement1_10 implements HtmlGeneratorElement, FormSubmissionControllerAction{

	protected final Log log = LogFactory.getLog(StandardRegimenElement1_10.class);
	...
	private Order newDiscontinuationOrder(Date discontinuedDate, String discontinuedReasonStr, Order o) {
	    ...
	    discontinuationOrder.setDateStopped(discontinuedDate);
