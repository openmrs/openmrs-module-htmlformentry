 ...
 * tag with a dynamically generated string. (For example {@code <encounterDate/>} gets substituted
 * with appropriate Date widget.) Just override the getSubstitution() method.
 */
public abstract class SubstitutionTagHandler extends AbstractTagHandler {
	 ...
	 */
	abstract protected String getSubstitution(FormEntrySession session, FormSubmissionController controllerActions,
