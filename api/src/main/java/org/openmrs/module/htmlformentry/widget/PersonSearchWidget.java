...
public class PersonSearchWidget implements Widget {
	...
	public String generateHtml(FormEntryContext context) {
		...
		sb.append(
		    "', (openmrsContextPath.startsWith('/') ? '' : '/') + openmrsContextPath + '/module/htmlformentry/personSearch.form?inPopup=true&prefix=");
		sb.append(context.getFieldName(this));
		...
		sb.append(context.getFieldName(this));
		sb.append(
		    "' width='100%' height='100%' marginWidth='0' marginHeight='0' frameBorder='0' scrolling='auto'></iframe> \n");
		sb.append("</div>");
