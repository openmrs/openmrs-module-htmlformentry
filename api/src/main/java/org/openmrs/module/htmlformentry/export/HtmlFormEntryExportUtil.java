...
>>>>>>> bbbf9316a13ae663b033309069d6d21b6bbd764f
     ...
     */
    public static StringBuffer buildHtmlFormExport(List<Encounter> encounters, HtmlForm htmlForm,
																					List<String> extraCols, StringBuffer sb, Locale locale,
																					List<PatientIdentifierType> pitList) {
        try {
