...
public class HtmlFormValidator implements Validator {
	 ...
	 * <strong>Should</strong> reject xml containing encounter type tag for a form with an encounter
	 * type <strong>Should</strong> allow xml containing encounter type tag for a form with no encounter
	 * type
	 */
	@Override
