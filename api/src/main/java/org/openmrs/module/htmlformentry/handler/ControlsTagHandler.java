 ...
 * Usage is something like this: <pre>
    <obsgroup groupingConceptId="PIH:HUM Disposition construct">
        Disposition:
        <obs id="disposition" conceptId="PIH:HUM Disposition categories" answerConceptIds=
"PIH:Transfer out of hospital,...">
            <controls>
        ...
        <p id="transfer-out-location">
            Transfer to:
            <obs conceptId="PIH:Transfer out location" answerConceptIds=
"PIH:ZL-supported site,PIH:Non-ZL supported site"/>
        </p>
    </obsgroup>
 </pre>
 */
