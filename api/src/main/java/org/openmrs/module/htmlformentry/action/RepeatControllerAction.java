...
/**
 * Abstract class which defines a controller that can hold a set of Form Submission Controller
 * Actions, and is itself a Form Submission Controller Action.
 */
public abstract class RepeatControllerAction implements FormSubmissionControllerAction {
	...
	/**
	 * Calls the handleSubmission method for all Form Submission Controller Actions associated with this
	 * Repeat Controller
	 * 
	 * @param session
	 * @param submission
	...
	/**
	 * Calls the validateSubmission method for all Form Submission Controller Actions associated with
	 * this Repeat Controller
	 * 
	 * @param context
	 * @param submission
	 */
