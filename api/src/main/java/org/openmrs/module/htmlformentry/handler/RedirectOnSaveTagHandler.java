...
/**
 * Supports two usages: <redirectOnSave url=
 * "/modules/custom/displayForPrinting.form?patientId={{patient.id}}&encounterId={{encounter.id}}"/>
 * <redirectOnSave script="groovy"> import org.openmrs.api.context.Context; def customView =
 * Context.getAdministrationService().getGlobalProperty("custom.view"); return "custom.form?view=" +
 * customView + "&amp;patientId={{patient.id}}"; </redirectOnSave>
 */
