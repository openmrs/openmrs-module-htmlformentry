 ...
 * submissionActions.addCustomFormSubmissionAction(CustomFormSubmissionAction). The
 * applyAction(session) method will then be called at the end of the "applyActions" phase of form
 * submission (see FormEntrySession.applyActions()) For an example of usage, see:
