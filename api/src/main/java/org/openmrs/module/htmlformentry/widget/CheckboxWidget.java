...
public class CheckboxWidget implements Widget {
	...
	/**
	 * Gets the value attribute for the checkbox. Not to be confused with
	 * {@see getValue(FormEntryContext,HttpServletRequest)}.
	 * 
	...
	public String generateHtml(FormEntryContext context) {
		...
		if (context.getMode() == Mode.VIEW) {
			...
			sb.append("<input type=\"checkbox\" id=\"").append(context.getFieldName(this)).append("\" name=\"")
			        .append(context.getFieldName(this)).append("\" value=\"").append(value).append("\"");
	...
	public CheckboxWidget clone() {
		CheckboxWidget clone = new CheckboxWidget(this.getLabel(), this.getValue(), this.getToggleTarget(),
		        this.isToggleDimInd());
