...
public class EncounterLocationTagTest extends BaseModuleContextSensitiveTest {
	...
	public void getAllChildAndGrandLocations_shouldReturnAllGrandAndChildLocations() {
		...
		assertThat(EncounterDetailSubmissionElement.getAllChildAndGrandLocations(allVisitLocations).size(), is(9));
