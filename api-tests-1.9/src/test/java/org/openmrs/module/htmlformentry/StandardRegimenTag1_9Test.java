...
public class StandardRegimenTag1_9Test extends BaseModuleContextSensitiveTest {
	...
	public void testStandardRegimenTag_shouldRecognizeStandardRegimenInEditMode_AllFields() throws Exception {
		new RegressionTestHelper() {
			...
			public Encounter getEncounterToView() {
				...
				RegimenSuggestion rsug = StandardRegimenUtil.getStandardRegimenByCode(rs, "all3");
				Set<Order> dors = StandardRegimenUtil.standardRegimenToDrugOrders(rsug, date, p);
				for (Order o : dors) {
	...
	public void testStandardRegimenTag_shouldRecognizeAllFields_StartDateAndRegimenOnly() throws Exception {
		new RegressionTestHelper() {
			...
			public Encounter getEncounterToView() {
				...
				RegimenSuggestion rsug = StandardRegimenUtil.getStandardRegimenByCode(rs, "drug2and3");
				Set<Order> dors = StandardRegimenUtil.standardRegimenToDrugOrders(rsug, date, p);
				for (Order o : dors) {
					e.addOrder(o);
				}
